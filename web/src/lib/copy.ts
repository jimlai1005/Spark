...
export const COPY_ZH = {
  ...
  /**
   * `/contact` 聯絡頁（2026-09-02 Task 6，雙欄深色設計稿重做）：表單送到
   * POST /api/public/contact，由站主人工回覆。**沒有姓名欄**——`topic`
   * （五顆單選 chip）取代之。`fallbackEmail` 只在錯誤訊息（502/503）裡出現，
   * 頁面本身不再顯示保底 mailto 句。
   */
  contact: {
    eyebrow: "CONTACT",
...
export const COPY_EN: DeepString<typeof COPY_ZH> = {
  ...
  strategyDetail: {
    ...
    equity: {
      ...
      overlayUnavailable: "Data unavailable",
  ...
  contact: {
    eyebrow: "CONTACT",
    heading: "Contact us",
    sub: "Copy-trading issues, billing questions, security reports, or partnership proposals — send them all here. We reply to the email you leave, usually within 1 business day.",
    checklistTitle: "Before you send",
    check1: "For copy-trading or account issues, include your wallet address so we can match it to on-chain records.",
    check2: "Our reply subject line will carry the ticket number FLT-XXXX-XXXX — use it to confirm the reply is from us.",
    checkWarnPrefix: "The Filet team ",
    checkWarnStrong: "will never",
    checkWarnSuffix: " ask for your private key, seed phrase, or a transfer. Treat any such message as a scam.",
    securityNote: "For a security vulnerability, choose \"Security report\" — it goes into our priority queue.",
    topicLabel: "Topic",
    topics: { copytrade: "Copy-trading issue", billing: "Billing & account", security: "Security report", partnership: "Partnership", other: "Other" },
    emailLabel: "Email",
    emailHint: "We'll reply here",
    emailPlaceholder: "you@example.com",
    walletLabel: "Wallet address",
    walletHint: "Optional · auto-filled when logged in",
    walletPlaceholder: "0x…",
    walletConnected: "Wallet linked",
    walletUseOther: "Use a different address",
    messageLabel: "Message",
    messagePlaceholder: "Describe what happened, roughly when (UTC), and what you expect. For copy-trading issues, include the strategy name or the address you're following.",
    consent: "By sending, you agree we may use this email to reply to your question. It will not be used for any other purpose.",
    send: "Send message",
    sending: "Sending…",
    successTitle: "Sent",
    successBody: "We'll reply to {email}. Our reply subject line will carry this ticket number.",
    sendAnother: "Send another",
    fallbackEmail: "goldwisetw@gmail.com",
    fallbackPrefix: "or email us directly at ",
    errEmailInvalid: "Please enter a valid email address",
    errWalletInvalid: "Wallet address format is invalid (0x + 40 hex characters)",
